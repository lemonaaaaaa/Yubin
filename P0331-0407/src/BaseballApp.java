			...
			if (menu == 1) {// 로그인 기능
				...
				while (true) {
					...
					if (menu2 == 1) {// 게시글 입력
						...
						BaseballGall b1 = new BaseballGall(0, postName, postNae, loginId, null);
						...
						int postNo = scn.nextInt();
//					List<Baseball> list = service.deleteBaseballName(postNo);
//					for (Baseball b : list) {
...
//					}**********************************
						if (postNo == 0) {
							...
							if (service.deleteBaseballPostNo(postNo, loginId)) {
