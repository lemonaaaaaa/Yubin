...
public class SendExample {
	public static void main(String[] args) {
		 ...
		 */
		String api_key = "NCSJ4VUXLIRAYYMB";
		String api_secret = "NEQN3LW2P3KEM2ZQODXSNGHMQUQTPSLG";
		...
		set.put("to", "010-5701-8439"); // 수신번호

		// 10월 16일 이후로 발신번호 사전등록제로 인해 등록된 발신번호로만 문자를 보내실 수 있습니다.
		set.put("from", "010-7634-7242"); // 발신번호
		set.put("text", "빛이 나는 솔로"); // 문자내용
